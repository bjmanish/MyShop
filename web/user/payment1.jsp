...
<input type="text" class="form-control required-field" placeholder="Card Holder Name" id="cardname">
</div>

<div class="mb-3 input-group">
<span class="input-group-text"><i class="bi bi-credit-card"></i></span>
<input type="text" class="form-control required-field" placeholder="Card Number" id="cardnumber">
</div>

<div class="row">
<div class="col-6 mb-3 input-group">
<span class="input-group-text"><i class="bi bi-calendar"></i></span>
<input type="number" class="form-control required-field" placeholder="MM" id="mm">
</div>

<div class="col-6 mb-3 input-group">
<span class="input-group-text"><i class="bi bi-calendar2"></i></span>
<input type="number" class="form-control required-field" placeholder="YYYY" id="yyyy">
</div>
</div>

<div class="mb-3 input-group">
<span class="input-group-text"><i class="bi bi-shield-lock"></i></span>
<input type="password" class="form-control required-field" placeholder="CVV" id="cvv">
</div>
...
function verifyOtp(){
    ...
    .then(data => {
        ...
        if(data.status === "success"){
                ...
                if(res.status === "success"){
                    ...
                    Swal.fire({
                        ...
                        window.location.href =
                            "orderSuccess.jsp?orderId=" + res.orderId;
                    });

                } else {
                    Swal.fire("Error","Order failed","error");
                    console.log("Order failed",res.status);
                }
            ...
            setTimeout(() => {
                otpInputs.forEach(input => input.classList.remove("otp-error"));
            }, 300);
